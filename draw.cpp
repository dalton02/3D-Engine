...
void drawRaster(SDL_Renderer* renderer,vector<triangle> triRasterizados){
	...
	for(int i=0;i<triRasterizados.size();i++){
        ...
        vector<SDL_Vertex> defaultColor = {
        {SDL_FPoint{triRasterizados[i].vertexs[0].x,triRasterizados[i].vertexs[0].y},SDL_Color{255,255,255},SDL_FPoint{0}},
        {SDL_FPoint{triRasterizados[i].vertexs[1].x,triRasterizados[i].vertexs[1].y},SDL_Color{255,255,255},SDL_FPoint{0}},
        {SDL_FPoint{triRasterizados[i].vertexs[2].x,triRasterizados[i].vertexs[2].y},SDL_Color{255,255,255},SDL_FPoint{0}},
        };

        SDL_RenderGeometry(renderer,nullptr,verts.data(),verts.size(),nullptr,0);
        //SDL_RenderGeometry(renderer,nullptr,defaultColor.data(),defaultColor.size(),nullptr,0);
